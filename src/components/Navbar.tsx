      ...
      >
        ...
        >
          <div className="flex flex-col gap-8 pt-16">
            ...
            >
              <span className="font-sans font-black text-2xl tracking-tighter text-[#18181B] dark:text-[#FAF6F0]">AGENCIA</span>
              <span className="font-accent text-4xl text-primary font-bold rotate-[-6deg]">Inmobiliaria</span>
            </Link>
