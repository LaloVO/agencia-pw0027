    ...
    <div className="w-full max-w-4xl mx-auto px-4 md:px-0">
            ...
            <React.Fragment key={step.id}>
              <div className="flex flex-col items-center shrink-0">
                <button
                  ...
                  className={`w-9 h-9 rounded-full border-2 flex items-center justify-center font-sans font-medium text-xs transition-all duration-300
                    ${isCompleted ? "bg-[#F97316] border-[#F97316] text-white" : ""}
                    ${isCurrent && !isCompleted ? "border-[#F97316] bg-white text-[#F97316] scale-105 shadow-md" : ""}
                ...
                <span className={`text-[10px] md:text-xs mt-1.5 font-sans font-medium hidden md:block
                  ${isCurrent ? "text-[#18181B] font-semibold" : "text-[#64748B]/60"}
                `}>
                  {step.title}
                </span>
              </div>
              {!isLast && (
                <div className="h-[2px] flex-1 bg-[#64748B]/20 rounded min-w-[20px]">
                  <div
                    className="h-full bg-[#F97316] transition-all duration-300 rounded"
      ...
      <div className="bg-white/45 backdrop-blur-lg border border-white/40 rounded-3xl p-6 md:p-10 shadow-elegant mt-8 min-h-[460px] relative transition-all duration-300">
        ...
        {currentStep === 1 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#18181B] font-medium">Información Personal</h2>
            ...
            <div className="space-y-5 max-w-lg mx-auto">
              <div className="space-y-2">
                <Label htmlFor="nombreCompleto" className="font-sans text-sm font-medium text-[#18181B] flex items-center gap-2">
                ...
                <Input
                  ...
                  className={`rounded-full bg-white/70 dark:bg-[#121214]/40 backdrop-blur-md border-[#64748B]/20 focus:bg-white/10 dark:focus:bg-black/20 focus:text-primary focus:border-[#F97316] focus:ring-0 ${
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="font-sans text-sm font-medium text-[#18181B] flex items-center gap-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="telefono" className="font-sans text-sm font-medium text-[#18181B] flex items-center gap-2">
        ...
        {currentStep === 2 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#18181B] font-medium">Características del Inmueble</h2>
              <p className="font-sans text-sm text-[#64748B] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-[#18181B] flex items-center gap-2">
                ...
                >
                    ...
                    <Label
                      ...
                      className={`flex-1 cursor-pointer border rounded-2xl p-4 flex flex-col justify-between h-20 transition-all duration-300
                        ${watch("tipoOperacion") === "compra" 
                          ? "bg-white border-[#F97316] shadow-elegant scale-[1.02]" 
                          : "bg-white/40 border-[#64748B]/10 hover:bg-white/60"
                        }
                      `}
                    >
                      <span className="font-sans font-semibold text-sm text-[#18181B]">Comprar</span>
                  ...
                  <div className="flex items-center space-x-2 flex-1">
                    ...
                    <Label
                      ...
                      `}
                    >
                      <span className="font-sans font-semibold text-sm text-[#18181B]">Rentar</span>
              ...
              {/* Tipo de Propiedad */}
              <div className="space-y-2">
                <Label htmlFor="tipoPropiedad" className="font-sans text-sm font-medium text-[#18181B]">
                  Tipo de Propiedad *
                </Label>
                <Select
                ...
                >
                  <SelectTrigger className={`rounded-full bg-white/70 dark:bg-[#121214]/40 backdrop-blur-md border-[#64748B]/20 focus:bg-white/10 dark:focus:bg-black/20 focus:text-primary focus:ring-0 ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="rounded-full bg-white/70 dark:bg-[#121214]/40 backdrop-blur-md border-[#64748B]/20">
                ...
                <div className="space-y-2">
                  <Label className="font-sans text-xs font-medium text-[#64748B] flex items-center gap-1.5">
                    <Bath className="w-3.5 h-3.5 text-[#F97316]" />
                    Baños
                  </Label>
                  <Select
              ...
              <div className="space-y-2">
                <Label className="font-sans text-sm font-medium text-[#18181B] flex items-center gap-2">
                  <Maximize className="w-4 h-4 text-[#F97316]" />
        ...
        {currentStep === 3 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-6">
              <h2 className="font-serif text-3xl text-[#18181B] font-medium">Ubicación y Estilo de Vida</h2>
              <p className="font-sans text-sm text-[#64748B] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="flex-1 h-10 rounded-full border border-[#64748B]/20 bg-white/70 dark:bg-[#121214]/40 backdrop-blur-md px-4 py-2 text-sm font-sans focus:bg-white/10 dark:focus:bg-black/20 focus:text-primary focus:border-[#F97316]"
                  >
                  ...
                  <Button
                    ...
                    className="rounded-full bg-[#F97316] hover:bg-[#EA580C]"
                  >
                    Agregar
                  </Button>
                </div>
                <div className="flex flex-wrap gap-2 min-h-[30px]">
                  {estadosDeseados.map((estado: string) => (
                    <Badge key={estado} variant="secondary" className="rounded-full px-3 py-1 font-sans bg-white border border-[#64748B]/25 text-[#18181B] flex items-center gap-1.5">
                      {estado}
                      <button
                        type="button"
              ...
              {/* Ciudades Deseadas */}
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-[#18181B]">Ciudades o Municipios Específicos</Label>
                <div className="flex gap-2">
                  <Input
                    value={ciudadInput}
                    ...
                    className="rounded-full bg-white/70 dark:bg-[#121214]/40 backdrop-blur-md border-[#64748B]/20 focus:bg-white/10 dark:focus:bg-black/20 focus:text-primary focus:border-[#F97316]"
                  />
                  <Button
                    type="button"
                ...
                <div className="flex flex-wrap gap-2 min-h-[30px]">
                  {ciudadesDeseadas.map((ciudad: string) => (
                    <Badge key={ciudad} variant="secondary" className="rounded-full px-3 py-1 font-sans bg-white border border-[#64748B]/25 text-[#18181B] flex items-center gap-1.5">
                      {ciudad}
                      <button
                        type="button"
              ...
              {/* Zonas Específicas */}
              <div className="space-y-2">
                <Label htmlFor="zonasEspecificas" className="font-sans text-sm font-medium text-[#18181B]">
              ...
              <div className="space-y-3 bg-[#FAF6F0]/60 border border-[#F97316]/25 rounded-2xl p-5 md:p-6 shadow-card">
                <Label htmlFor="estiloVidaDescripcion" className="font-sans text-[#18181B] font-medium text-base flex items-center gap-2">
                ...
                <Textarea
                  ...
                  className={`bg-white/70 border-[#64748B]/20 focus:bg-white/10 dark:focus:bg-black/20 focus:text-primary focus:border-[#F97316] focus:ring-0 rounded-2xl ${
        ...
        {currentStep === 4 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#18181B] font-medium">Presupuesto y Financiamiento</h2>
              <p className="font-sans text-sm text-[#64748B] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="bg-[#FAF6F0]/60 border border-[#64748B]/10 rounded-2xl p-5 md:p-6 shadow-card space-y-4">
                <Label className="font-sans text-base font-semibold text-[#18181B] flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`rounded-full pl-7 bg-white/70 dark:bg-[#121214]/40 backdrop-blur-md border-[#64748B]/20 focus:bg-white/10 dark:focus:bg-black/20 focus:text-primary focus:border-[#F97316] focus:ring-0 ${
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  {METODOS_PAGO.map((metodo) => (
                    <div
                      key={metodo.id}
                      className="flex items-start space-x-3 p-4 bg-white/70 dark:bg-[#121214]/40 backdrop-blur-md border border-[#64748B]/10 rounded-2xl hover:bg-white transition-colors duration-300 cursor-pointer shadow-card"
                    ...
                    >
                      <Checkbox
                        ...
                        className="mt-0.5 border-[#F97316]/40 data-[state=checked]:bg-[#F97316] data-[state=checked]:border-[#F97316]"
                      />
                      <div className="flex-1">
                        <Label htmlFor={metodo.id} className="font-sans font-medium text-sm text-[#18181B] cursor-pointer">
                          {metodo.label}
                        </Label>
              ...
              <div className="bg-white/40 border border-[#64748B]/10 rounded-2xl p-5 shadow-card space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="tienePrecalificacion" className="font-sans font-medium text-[#18181B]">
        ...
        {currentStep === 5 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#18181B] font-medium">Uso del Inmueble</h2>
              <p className="font-sans text-sm text-[#64748B] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-[#18181B]">¿Cuál será el uso de destino principal? *</Label>
                <RadioGroup
                        ...
                        <Label
                          ...
                          className={`flex-1 cursor-pointer border rounded-2xl p-4 flex gap-4 items-center transition-all duration-300 shadow-card
                            ${watch("usoDestino") === opc.id
                              ? "bg-white border-[#F97316] scale-[1.01]"
                              : "bg-white/40 border-[#64748B]/10 hover:bg-white/60"
                            }
                          `}
                        >
                          <div className="bg-[#FAF6F0] p-2.5 rounded-xl border border-[#64748B]/10 text-[#F97316]">
                            <Icon className="w-5 h-5" />
                          </div>
                          <div>
                            <span className="font-sans font-semibold text-sm text-[#18181B]">{opc.label}</span>
              ...
              {/* Detalles del Uso */}
              <div className="space-y-2">
                <Label htmlFor="detallesUso" className="font-sans text-sm font-medium text-[#18181B]">
                ...
                <Textarea
                  ...
                  className="bg-white/70 dark:bg-[#121214]/40 backdrop-blur-md border-[#64748B]/20 focus:bg-white/10 dark:focus:bg-black/20 focus:text-primary focus:border-[#F97316] focus:ring-0 rounded-2xl"
                />
              </div>
            </div>
          </div>
        ...
        {currentStep === 6 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#18181B] font-medium">Expediente de Documentos</h2>
              <p className="font-sans text-sm text-[#64748B] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-6 border border-[#64748B]/15 shadow-card hover:border-[#F97316]/30 transition-all duration-300 space-y-4">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 space-y-1">
                    <h3 className="font-sans text-base font-semibold text-[#18181B] flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full h-10 rounded-full border border-[#64748B]/20 bg-white px-4 text-sm font-sans focus:border-[#F97316] focus:outline-none"
                        />
                      </div>
                        ...
                        {citaVirtualFecha ? (
                          isLoadingBusySlots ? (
                            <div className="h-10 flex items-center justify-center text-xs text-[#64748B]/60">
                              <Loader2 className="w-4 h-4 mr-2 animate-spin text-[#F97316]" />
                                    ...
                                    className={`h-9 rounded-full text-xs font-sans font-medium border transition-all duration-300
                                      ${isBusy 
                                        ...
                                        : isSelected
                                          ...
                                          : "bg-white border-[#64748B]/20 text-[#64748B] hover:border-[#F97316] hover:bg-[#FAF6F0]"
                                      }
                                    `}
                                  >
                                    {hour}
                ...
                <div className="space-y-3">
                  {TIPOS_DOCUMENTOS.map((doc) => {
                    ...
                    return (
                      <div
                        key={doc.id}
                        className="bg-white rounded-2xl p-4 border border-[#64748B]/15 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-card hover:border-[#F97316]/30 transition-all duration-300"
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-sans font-medium text-sm text-[#18181B]">
                              {doc.label}
                              {doc.requerido && <span className="text-red-500 ml-1">*</span>}
                            </p>
                            {uploadingDocs[doc.id] ? (
                              <span className="text-[10px] text-[#F97316] font-sans font-medium animate-pulse">Subiendo a base de datos...</span>
                            ) : isUploaded ? (
                        ...
                        <div className="shrink-0 flex items-center gap-3">
                          <Button
                            ...
                            className={`rounded-full font-sans text-xs border-[#64748B]/20 hover:bg-[#FAF6F0] hover:text-[#F97316] ${
              ...
              {/* Nota de Alerta */}
              <div className="bg-[#FAF6F0] border border-[#F97316]/20 rounded-2xl p-5 flex gap-3 shadow-card">
                <AlertCircle className="w-5 h-5 text-[#F97316] shrink-0 mt-0.5" />
                <div className="text-xs text-[#64748B] leading-relaxed">
                  <p className="font-sans font-semibold text-[#18181B] mb-1">Políticas de Privacidad e Integridad:</p>
                  <p>
      ...
      <div className="flex justify-between items-center mt-8 gap-4 px-2">
        ...
        {currentStep < STEPS.length ? (
          <Button
            ...
            className="rounded-full px-8 bg-[#F97316] hover:bg-[#EA580C] font-sans text-sm text-white shadow-md hover:scale-105 transition-all duration-300"
          >
            Siguiente
          ...
          <Button
            ...
            disabled={isSubmitting}
            className="rounded-full px-8 bg-[#F97316] hover:bg-[#EA580C] font-sans text-sm text-white shadow-md hover:scale-[1.03] transition-all duration-300"
          >
            {isSubmitting ? (
              <>
